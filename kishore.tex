...
% set PDF metadata
\hypersetup{%
pdftitle={Relationship between Newton's second law and acceleration, mass, and force},
pdfauthor={Nitika Kishore, Sameera Patil, Anton Lavrenov, and Connor Paskiewicz},
}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RE,RO]{J S\&E \textbf{1}, 21--22 (2024)}
\fancyhead[LO]{Kishore et al.}
\fancyhead[LE]{Relationship between Newton's second law}
\fancyfoot[C]{\thepage}
\fancypagestyle{mytitlepage}{
\fancyhf{}
\fancyhead[C]{Journal of Science \& Engineering \textbf{1}, 21--22 (2024)}
\fancyfoot[C]{\thepage}
}
